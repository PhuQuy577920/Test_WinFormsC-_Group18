...
namespace PMTHITN
{
    public partial class frmgv : Form
    {
        ...
        public void frmgv_Load(object sender, EventArgs e)
        {
            // Code tải dữ liệu ban đầu có thể được di chuyển vào một phương thức khác để tái sử dụng hoặc bỏ qua trong unit test.
            // Cần đảm bảo việc gán kết nối vào biến conn vẫn được thực hiện.
        ...
        {
            // Thay đổi phương thức này để nhận vào một SqlDataAdapter
            // Điều này cho phép bạn inject SqlDataAdapter từ unit test
            // Đồng thời, không cần sửa đổi biến global
            dt = new DataTable();
        ...
        public void piccauhoi_Click(object sender, EventArgs e)
        {
            // môn thi
        ...
        public void picmonthi_Click(object sender, EventArgs e)
        {
            // Môn thi
        ...
        public void picsv_Click(object sender, EventArgs e)
        {
            // Đổi tên lbl
            lblmamon.Text = "Mã SV:";
        ...
        public void cmbloc_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        public void linktimch_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        public void linkthemch_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        public void linksuach_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        public void linkxoach_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        public void txtmsv_TextChanged(object sender, EventArgs e)
        {
        ...
        public void dgvmenu_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            //CÂU HỎI
            if (grbcauhoi.Text == "Danh sách câu hỏi")
            {
